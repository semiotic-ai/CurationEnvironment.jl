...
for i in 1:nt
    ...
    body = """
\\def\\sharesCurr{$(round(sharesCurr; digits=4))}
\\def\\sharesNew{$(round(sharesNew; digits=4))}
\\def\\price{$(round(price; digits=4))}
\\def\\feeRate{$(round(df[i, :]["feeRate"]; digits=4))}
...
\\def\\newEquity{$(round(newEquity; digits=4))}
    """
