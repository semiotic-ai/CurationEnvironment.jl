@testset "crspe" begin
    ...
    @testset "single_bidder" begin
        cs = [
            CurationEnvironment.Curator{1,Int64,Float64}(1, (110.0,), (0.0,), 100.0)
            CurationEnvironment.Curator{1,Int64,Float64}(2, (100.0,), (0.0,), 50.0)
        ]
        s = CurationEnvironment.Subgraph(1, 100.0, 0.0, 0.0)
        ps = [10, 0]
        t = mint
    ...
    @testset "multiple_bidders" begin
        cs = [
            CurationEnvironment.Curator{1,Int64,Float64}(1, (110.0,), (0.0,), 100.0)
            CurationEnvironment.Curator{1,Int64,Float64}(2, (105.0,), (0.0,), 50.0)
        ]
        s = CurationEnvironment.Subgraph(1, 100.0, 0.0, 0.0)
        ps = [10, 5]
        t = mint
        ...
        cs = [
            CurationEnvironment.Curator{1,Int64,Float64}(1, (110.0,), (0.0,), 100.0)
            CurationEnvironment.Curator{1,Int64,Float64}(2, (110.0,), (0.0,), 50.0)
        ]
        s = CurationEnvironment.Subgraph(1, 100.0, 0.0, 0.0)
        ps = [10, 10]
        t = mint
    ...
    @testset "auction" begin
        ...
        # No bids
        cs = [
            CurationEnvironment.Curator{1,Int64,Float64}(1, (100.0,), (0.0,), 100.0)
            CurationEnvironment.Curator{1,Int64,Float64}(2, (100.0,), (0.0,), 50.0)
        ]
        s = CurationEnvironment.Subgraph(1, 100.0, 0.0, 0.0)
        ps = [0, 0]
    ...
    @testset "step" begin
        ...
        cs = [
            CurationEnvironment.Curator{1,Int64,Float64}(1, (110.0,), (0.0,), 100.0)
            CurationEnvironment.Curator{1,Int64,Float64}(2, (90.0,), (10.0,), 50.0)
        ]
